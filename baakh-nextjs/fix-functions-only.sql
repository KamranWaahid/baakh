-- Fix just the functions to work without ON CONFLICT
-- This is a quick fix to get likes and bookmarks working
...
DECLARE
    result JSON;
BEGIN
    -- Insert the like without ON CONFLICT for now
...
DECLARE
    result JSON;
BEGIN
    -- Insert the bookmark without ON CONFLICT for now
