              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {activeTab === "periods" ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="event_sindhi_title">Sindhi Title</Label>
                        <Input
                          id="event_sindhi_title"
                          value={formData.event_sindhi_title}
                          onChange={(e) => setFormData({...formData, event_sindhi_title: e.target.value})}
                          placeholder="شاه عبداللطيف ڀٽائي جي پيدائش"
                          required
                        />
                      </div>
                      <div>
                        <Label htmlFor="event_english_title">English Title</Label>
                        <Input
                          id="event_english_title"
                          value={formData.event_english_title}
                          onChange={(e) => setFormData({...formData, event_english_title: e.target.value})}
                          placeholder="Birth of Shah Abdul Latif Bhittai"
                          required
                        />
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="event_sindhi_description">Sindhi Description</Label>
                        <Textarea
                          id="event_sindhi_description"
                          value={formData.event_sindhi_description}
                          onChange={(e) => setFormData({...formData, event_sindhi_description: e.target.value})}
                          placeholder="سنڌي شاعري جي عظيم شاعر..."
                        />
                      </div>
                      <div>
                        <Label htmlFor="event_english_description">English Description</Label>
                        <Textarea
                          id="event_english_description"
                          value={formData.event_english_description}
                          onChange={(e) => setFormData({...formData, event_english_description: e.target.value})}
                          placeholder="Birth of the great Sindhi poet..."
                        />
                      </div>
                    </div>
                  </>
