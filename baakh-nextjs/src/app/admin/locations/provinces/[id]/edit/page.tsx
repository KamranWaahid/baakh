  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to update province');
      }
      ...
      alert(error instanceof Error ? error.message : 'Failed to update province');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading province data...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Edit Province/State</h1>
